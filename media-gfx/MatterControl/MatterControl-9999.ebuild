...
SLOT="0"
KEYWORDS="~amd64"
IUSE="conf-debug conf-debug64 conf-release conf-release64 platform-any platform-mixed platform-x86 platform-x64"
...
src_install() {
    ...
    cp -R "${MATTERCONTROL_CHECKOUT_DIR}/bin/${PLATFORM}/${CONFIGURATION}" "${D}/usr/lib/${PN}/bin"
